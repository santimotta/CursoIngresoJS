...
-case: palabra reservada para crear un caso en el cual la variable tome un valor particular. Dicho valor debe declararse especificamente al lado del case.
